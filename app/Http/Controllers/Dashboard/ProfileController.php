...
use App\Http\Requests\Dashboard\Profile\UpdateDetailUserSRequest;
...
class ProfileController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(UpdateProfileRequest $request_profile, UpdateDetailUserSRequest $request_detail_user)
    {
        ...
        //process save to table detail user
