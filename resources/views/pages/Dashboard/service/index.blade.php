                                            ...
                                            <td class="w-2/6 px-1 py-5">
                                                <div class="flex items-center text-sm">
                                                    <div class="relative w-10 h-10 mr-3 rounded-full md:block">
                                                        ...
                                                        @if ($service->thumbnail_service[0]->thumbnail)
                                                            <img class="object-cover w-full h-full rounded" src="{{ Storage::url($service->thumbnail_service[0]->thumbnail) }}" alt="thumbnail" loading="lazy">
                                                        @else
                                                            <p class="text-red-600 font-medium text-sm">No Thumbnail</p>
                                                        @endif
